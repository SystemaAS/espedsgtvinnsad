		...
		//Oppdrag
	  	jq('#ehsadiIdLink').click(function() {
			if(jq('#ehpro').val()!=''){
	    		...
	    		window.open('tvinnsaddigitollv2_childwindow_sadi.do?action=doFind&tur=' + jq('#ehpro').val() + '&lnrt=' + jq('#emlnrt').val() + '&lnrm=' + jq('#emlnrm').val() + '&ctype=ehsadi', "oppdWin", "top=300px,left=600px,height=600px,width=1000px,scrollbars=yes,location=no");
			}
	    });
