  ...
  jq(function() {
	  //custom validity
		...
		jq('#emdkm_ffIdLink').click(function() {
	    	...
	    	window.open('tvinnsaddigitollv2_childwindow_external_master.do?action=doInit&date=20240101' + '&ctype=emdkm', "masterffWin", "top=300px,left=500px,height=600px,width=1200px,scrollbars=no,status=no,location=no");
	    });
