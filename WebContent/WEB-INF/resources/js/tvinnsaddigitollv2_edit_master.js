  ...
  jq(function() {
	  //custom validity
		...
		*/
	    ...
	    jq('#emproIdLink').click(function() {
	    	...
	    	window.open('tvinnsaddigitollv2_childwindow_tur.do?action=doInit&tudt=' + '&tupro=' + jq('#empro').val() + '&tuavd=' + jq('#emavd').val()  + '&ctype=empro', "turWin", "top=200px,left=300px,height=600px,width=1100px,scrollbars=no,status=no,location=no");
	    });
		...
		jq('#emdkm_ffIdLink').click(function() {
	    	...
	    	window.open('tvinnsaddigitollv2_childwindow_external_master.do?action=doInit&date=' + '&ctype=emdkm' + '&etlnrt=' + jq('#emlnrt').val(), "masterffWin", "top=300px,left=500px,height=600px,width=1400px,scrollbars=no,status=no,location=no");
	    });
		...
		jq('#emdkm_ffAttachmentsIdLink').click(function() {
	    	...
	    	window.open('tvinnsaddigitollv2_childwindow_external_master_attachments.do?action=doInit&date=20250101&docref='+ jq('#emdkm_ff').val() + '&ctype=emdkm_ff', "masterffWin", "top=300px,left=500px,height=600px,width=1400px,scrollbars=no,status=no,location=no");
	    });
	  ...
	  jq('#sendToPartIdLink').click(function() {
	    	...
	    	window.open('tvinnsaddigitollv2_childwindow_external_houses.do?action=doFind&ctype=ownReceiverOrgNr&emlnrt=' + 
						jq('#emlnrt').val() + '&emlnrm='+ jq('#emlnrm').val() + '&emdkm='+ jq('#emdkm').val() + jq('#own_emdkmUnique').val()  , 
						"codeWin", "top=300px,left=500px,height=600px,width=1200px,scrollbars=no,status=no,location=no");
	   });
