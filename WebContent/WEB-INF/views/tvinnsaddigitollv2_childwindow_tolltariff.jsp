...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsaddigitollv2_childwindow_tolltariff.js?ver=${user.versionEspedsg}"></SCRIPT>
	...
	<table width="90%" height="300px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						<table>
						<form name="tvinnsadImportTolltariffForm" id="tvinnsadImportTolltariffForm" action="tvinnsaddigitollv2_childwindow_tolltariff.do?action=doInit" method="post">
						<tr>
					...
					<table id="tolltariffList" class="display compact cell-border" width="100%" >
		                ...
		                <c:forEach var="record" items="${model.tolltariffList}" varStatus="counter">    
			               ...
			               <td nowrap style="cursor:pointer;" class="text14MediumBlue" id="vkod${record.tatanr}@text${record.taalfa}" >
			               		<img title="select" valign="bottom" src="resources/images/update.gif" border="0" alt="edit">&nbsp;${record.tatanr}
			               	</td>
		               	   <td class="text14">&nbsp;${record.taalfa}</td>
		               	   <td class="text14">&nbsp;${record.beskr1}</td>
