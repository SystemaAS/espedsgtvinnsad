...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsaddigitollv2_childwindow_externalhouse_advmelding_attachm_log.js?ver=${user.versionEspedsg}"></SCRIPT>
	
	<table width="90%" height="500px" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" cellspacing="0" border="0" cellpadding="0">
		<tr>
			<td colspan="3" class="text14Bold">&nbsp;&nbsp;&nbsp;
			Vedlegg - Adviseringsmelding
			</td>
		</tr>
		<tr>
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="mainList" class="display compact cell-border" width="100%" >
						...
						<tr class="tableHeaderField" height="20" >
							...
							<th class="text14" >&nbsp;&nbsp;</th>
							 --%>
							<th class="text14" >&nbsp;House-docId&nbsp;</th>
							<th class="text14" >&nbsp;Date&nbsp;</th>
		                    <th class="text14" >&nbsp;Time&nbsp;</th>
		                    <th class="text14" >&nbsp;Dok.navn&nbsp;</th>
		                ...
		                <tbody>
		                <c:forEach var="record" items="${model.zadmoattfList}" varStatus="counter">    
			               <tr class="text14">
			               	   <%--	
			                   <td style="cursor:pointer;" class="text14MediumBlue" id="orgnr${record.orgnr}_name${record.name}_commtype${record.commtype}_format${record.format}" >
				                ...
				                --%>	
			               	   ...
			               	   <td class="text14">&nbsp;${Xrecord.id}</td>
			               	   <td class="text14">&nbsp;${Xrecord.avsid}</td>
			               	   <td class="text14">&nbsp;${Xrecord.motid}</td>
			            	</tr> 
