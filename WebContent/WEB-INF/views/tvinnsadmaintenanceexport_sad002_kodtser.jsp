				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.ksefyl}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ksetxt}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="tvinnsadmaintenanceexport_sad002_kodtser_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text14" title="KSEFYL">&nbsp;<font class="text14RedBold" >*</font>F.kode</td>
						<td class="text14" title="KSETXT">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
