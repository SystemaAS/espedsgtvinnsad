			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="20%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Garantiref.</font>&nbsp;<font class="text14">TR030R</font>&nbsp;
				...
				<table id="containerdatatableTable" width="98%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.tgdtNO}&nbsp;</font></td>
						...
						<tr>
							...
							<td width="50%" valign="top">
								...
								<table width="90%" class="formFrame" cellspacing="1" border="0" align="left">
									<tr>
										<td class="text14" title="tgkna">&nbsp;Kundenr.</td>
									...
									<tr>	
										<td class="text14" title="tgtina">&nbsp;<font class="text14RedBold" >*</font>Organisasjonsnr.</td>
							...
							<td width="50%" valign="top">
								<table width="100%" cellspacing="1" border="0" align="left">
									<tr>
										<td class="text14" title="tgtsd">&nbsp;<font class="text14RedBold" >*</font>Garanti tollsted:</td>
									...
									<tr>	
										<td class="text14" title="tggfv">&nbsp;Gjeld følsom vare:</td>
										<td class="text14" >
											<select class="inputTextMediumBlue" name="tggfv" id="tggfv" >
									...
									<tr>
										<td class="text14" title="tgakny">&nbsp;<font class="text14RedBold" >*</font>Adgangskode:</td>
									...
									<tr>
										<td class="text14" title="tggbl">&nbsp;<font class="text14RedBold" >*</font>Garanti beløp:</td>
										<td class="text14" >
									...
									<tr>
										<td class="text14" title="tggblb">&nbsp;Brukt garantibeløp:</td>
										<td >
									...
									<tr>
										<td class="text14" title="tgprm">&nbsp;Varsling:</td>
										<td >
									...
									<tr>
										...
										<td class="text14" >
											<select class="inputTextMediumBlue" name="tgst" id="tgst" >
