							...
							<c:otherwise>
								...
								<td width="12%" valign="bottom" class="tabDisabled" align="center" nowrap>
									<a id="alinkOmberegning" style="display:block;" href="tvinnsadimport_edit_omberegning.do?action=doFetch&avd=${ model.record.siavd}&sign=${ model.record.sisg}
																&opd=${model.record.sitdn}-&status=${ model.record.sist}&pstatus=${ model.record.sist}&fabl=${ model.record.sibel3}&o2_sist=${ model.record.o2_sist}&o2_sidt=${ model.record.o2_sidt}&o2_simf=${ model.record.o2_simf}">
										<font class="tabDisabledLink">
					 		...
					 		<td width="100%">
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
							            ...
							            <td align="left">
							            	<select required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" class="inputTextMediumBlueMandatoryField" name="simva" id="simva" >
							        ...
							        <tr>
							            <td align="left">
											...
											<input tabindex=-1 type="checkbox" name="opdknum" id="opdknum" value="1" ><font class="text12">Oppdater kundereg.</font>
										</td>	
							        </tr>
			 		...
			 		<td>
						<table border="0" cellspacing="1" cellpadding="0">	
					 		<tr>
								...
								<td>
					            		<select required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" class="inputTextMediumBlueMandatoryField" name="silkt" id="silkt">
				 						<option value="">-velg-</option>
					 				  	<c:forEach var="country" items="${model.countryCodeList}" >
			            		...
			            		<td class="text9BlueGreen" valign="bottom" align="left" >
			 				    ...
			 				    <c:choose>
				 				    <c:when test="${ model.record.sist == 'M' || empty  model.record.sist }">
					 				    	...
					 				    	&nbsp;&nbsp;
					 				    	<c:if test="${not empty  model.record.sitdn && model.record.validUpdate}">
					 				    		<input tabindex=-2 class="inputFormSubmit" type="button" name="sendButton2" id="sendButton2" onclick="javascript: form.action='tvinnsadimport_send.do';" value='<spring:message code="systema.tvinn.sad.import.createnew.send"/>'/>
					 				    	</c:if>
				 				    </c:when>
				 				    <c:otherwise>
