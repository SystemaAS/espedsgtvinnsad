...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadncts5export_edit_items.js?ver=${user.versionEspedsg}"></SCRIPT>
	<style type = "text/css">
 	...
 	<table width="100%" class="tabThinBorderWhite" border="0" cellspacing="0" cellpadding="0">
		...
		<table border="0" width="95%" align="center" border="0">
           	...
           	<tr>
				<td>
					<table width="100%" cellspacing="0" border="0" cellpadding="0">
						...
						<tr >
							<td>
							<form id="createNewItemLine" action="tvinnsadncts5export_edit_items.do">
									 						  ...
									 						  <c:forEach items="${model.list}" var="record" varStatus="counter">    
													               ...
													               <c:if test="${model.status == 'G' ||  model.status=='F' || model.status == 'M' || empty model.status}">	
														               <td class="text14" align="center" nowrap>&nbsp;
														               	<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadncts5export_edit_items.do?action=doDelete&sign=${model.sign}&avd=${record.tvavd}&opd=${record.tvtdn}&lin=${record.tvli}">
			...
			<%-- ------------------------------------------------- --%>
           	...
           	<tr>
	 			<td >
	 			<form name="nctsExportEditTopicItemForm" id="nctsExportEditTopicItemForm" action="tvinnsadncts5export_edit_items.do" method="post">
						 		...
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							 		<tr>
							            ...
							            <img onMouseOver="showPop('35_info');" onMouseOut="hidePop('35_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
				 						<b>35.</b>
							            <span title="tivkb" >Brut.vekt(kg)</span>
							            <div class="text14" style="position: relative;" align="left">
										...
										<td class="text14" align="left"><b>&nbsp;38.</b>&nbsp;<span title="tivkn" >Net.vekt(kg)</span></td>
							        ...
							        <tr>
										...
										<td class="text14" align="left"><input onKeyPress="return amountKey(event)" type="text" class="inputText" name="tivkb" id="tivkb" size="10" maxlength="11" value="${model.record.tivkb}"></td>
										<td class="text14" align="left"><input onKeyPress="return amountKey(event)" type="text" class="inputText" name="tivkn" id="tivkn" size="10" maxlength="11" value="${model.record.tivkn}"></td>
										<%-- Doc.Type --%>
										<td >
									...
									<tr>
										...
										<img onMouseOver="showPop('31_kslag_info');" onMouseOut="hidePop('31_kslag_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
				 						<b>31.</b>
										<font class="text16RedBold" >*</font><span title="tipty" >Kollislag</span>
										<div class="text14" style="position: relative;" align="left">
										...
										<img onMouseOver="showPop('31_kantal_info');" onMouseOut="hidePop('31_kantal_info');"style="vertical-align:bottom;" width="12px" height="12px" src="resources/images/info3.png" border="0" alt="info">
				 						<b>31.</b><span title="tipnt" >Kolliant.</span>
										<div class="text14" style="position: relative;" align="left">
									...
									<tr>
								        ...
								        <span style="position:absolute; left:280px; top:500px; width:650px; height:260px;" id="44_aditionalInfo_01" class="popupWithInputText"  >
								           		<div class="text10" align="left">
								           			...
								           			<td>
														...
														<tr>
															...
															<td class="text14">&nbsp;<span title="tvdo" >Supplerende Opplysn.</span></td>
															<td class="text14">&nbsp;<span title="tvdosk" >Språk</span></td>
														</tr>
									           			<tr>
					           							...
					           							<tr>
										           			<td class="text14">&nbsp;<span title="tvtlo" >Kode [Supplerende opplysninger]</span></td>
										           			<td class="text14">&nbsp;</td>
										           			<td class="text14">&nbsp;<span title="tvexkd" >Eksport fra EF</span></td>
															<td class="text14">&nbsp;<span title="tvexlk" >Eksport fra land</span></td>
					           							...
					           							<tr>
										           			<td class="text14" colspan="3">&nbsp;<span title="tvmtxt" >Yderligere opplysninger</span></td>
															<td class="text14">&nbsp;<span title="tvmsk" >Språk</span></td>
					           			...
					           			<td align="left">
					            			<select class="inputTextMediumBlueMandatoryField" name="tipty" id="tipty">
							            		<option value="">-velg-</option>
							 				  	<c:forEach var="record" items="${model.ncts017_Kolli_CodeList}" >
			                                	 	<option value="${record.tkkode}"<c:if test="${model.record.tipty == record.tkkode}"> selected </c:if> >${record.tkkode}</option>
												</c:forEach> 
											</select>
											<a tabindex="-1" id="tvehIdLink TODO tiptyIdLink">
												<img style="cursor:pointer;vertical-align: middle;" src="resources/images/find.png" width="14px" height="14px" border="0" alt="search" >
											</a>										
				            				</td> 
				            				<td class="text14" valign="bottom">
											&nbsp;<input onKeyPress="return numberKey(event)" type="text" class="inputText" name="tipnt" id="tipnt" size="5" maxlength="5" value="${model.record.tipnt}">
										</td>
										<td class="text14" valign="bottom">
								        ...
								        <span style="position:absolute; left:580px; top:500px; width:350px; height:300px;" id="itemDescriptionExtraInformation" class="popupWithInputText"  >
								           		<div class="text10" align="left">
													...
													<table width="100%" align="left" border="0">
														<tr align="left" >
															<td class="text14"><button name="itemDescriptionExtraInformationButtonClose" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('itemDescriptionExtraInformation');">&nbsp;<spring:message code="systema.tvinn.sad.ok"/></button> 
															</td>
														</tr>
													</table>
												</div>
            ...
            <tr>
					...
					<%-- Item input --%>
				 	<table width="100%" align="center" class="secondarySectionFrame" border="0" cellspacing="0" cellpadding="0">
				 		...
				 		<tr>
		            		...
		            		<div class="text14" style="position: relative;" align="left">
							<span style="position:absolute;top:2px; width:250px;" id="tvtdn2_info" class="popupWithInputText text14"  >
							        ...
							        <tr>
							        	<td>
							        		...
							        		<tr>
							            		...
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvpss" >Postadresse</span></td>
							            	</tr>
							        		<tr>
							            ...
							            <td>
							            	<table>
							        		<tr>
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvlks" >Landkode</span>
							            		
							            		</td>
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvsks" >Språkkode</span>
							        ...
							        <tr>
							        	<td>
							        		...
							        		<tr>
							            		...
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvpsk" >Postadresse</span></td>
							            	</tr>
							        		<tr>
							            ...
							            <td>
							            	<table>
							        		<tr>
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvlkk" >Landkode</span>
							            		
							            		
							            		</td>
							            		<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvskk" >Språkkode</span>
				 		...
				 		<tr>
					 		<td width="50%">
						 		<table border="0" cellspacing="1" cellpadding="0">
							        ...
							        <tr height="5"><td class="text" align="left"></td></tr>
									<tr>
							            <td class="text14" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Supplerende opplysninger&nbsp;</td>
								        ...
								        <span style="position:absolute; left:280px; top:800px; width:650px; height:580px;" id="specialInformationCode" class="popupWithInputText"  >
								           		<div class="text10" align="left">
								           			...
								           			<td>
														...
														<tr>
										           			<td class="text14">&nbsp;<span title="tvdty2" >Dok.type</span></td>
										           			<td class="text14">&nbsp;<span title="tvdref2" >Dok.ref.</span></td>
															<td class="text14">&nbsp;<span title="tvdsk2" >Dok.språk</span></td>
															
															<td class="text14">&nbsp;<span title="tvdo2" >Supplerende Opplysn.</span></td>
															<td class="text14">&nbsp;<span title="tvdosk2" >Språk</span></td>
														</tr>
									           			<tr>
										           			<td class="text14" nowrap >
					           							...
					           							<tr>
										           			<td class="text14">&nbsp;<span title="tvtlo2" >Kode [Supplerende opplysninger]</span></td>
										           			<td class="text14">&nbsp;</td>
										           			<td class="text14">&nbsp;<span title="tvexkd2" >Eksport fra EF</span></td>
															<td class="text14">&nbsp;<span title="tvexlk2" >Eksport fra land</span></td>
					           							...
					           							<tr>
										           			<td class="text14" colspan="3">&nbsp;<span title="tvmtxt2" >Yderligere opplysninger</span></td>
															<td class="text14">&nbsp;<span title="tvmsk2" >Språk</span>
															</td>
								           			...
								           			<td>
														...
														<tr>
										           			<td class="text14">&nbsp;<span title="tvdty3" >Dok.type</span></td>
										           			<td class="text14">&nbsp;<span title="tvdref3" >Dok.ref.</span></td>
															<td class="text14">&nbsp;<span title="tvdsk3" >Dok.språk</span></td>
															<td class="text14">&nbsp;<span title="tvdo3" >Supplerende Opplysn.</span></td>
															<td class="text14">&nbsp;<span title="tvdosk3" >Språk</span></td>
														</tr>
									           			<tr>
										           			<td class="text14" nowrap>
					           							...
					           							<tr>
										           			<td class="text14">&nbsp;<span title="tvtlo3" >Kode [Supplerende opplysninger]</span></td>
										           			<td class="text14">&nbsp;</td>
										           			<td class="text14">&nbsp;<span title="tvexkd3" >Eksport fra EF</span></td>
															<td class="text14">&nbsp;<span title="tvexlk3" >Eksport fra land</span></td>
					           							...
					           							<tr>
										           			<td class="text14" colspan="3">&nbsp;<span title="tvmtxt3" >Yderligere opplysninger</span></td>
															<td class="text14">&nbsp;<span title="tvmsk3" >Språk</span></td>
														</tr>
									           			<tr>
										           			<td class="text14" colspan="3" >
								           			...
								           			<td>
														...
														<tr>
										           			<td class="text14">&nbsp;<span title="tvdty4" >Dok.type</span></td>
										           			<td class="text14">&nbsp;<span title="tvdref4" >Dok.ref.</span></td>
															<td class="text14">&nbsp;<span title="tvdsk4" >Dok.språk</span></td>
															<td class="text14">&nbsp;<span title="tvdo4" >Supplerende Opplysn.</span></td>
															<td class="text14">&nbsp;<span title="tvdosk4" >Språk</span></td>
														</tr>
									           			<tr>
										           			<td class="text14" nowrap>
					           							...
					           							<tr>
										           			<td class="text14">&nbsp;<span title="tvtlo4" >Kode [Supplerende opplysninger]</span></td>
										           			<td class="text14">&nbsp;</td>
										           			<td class="text14">&nbsp;<span title="tvexkd4" >Eksport fra EF</span></td>
															<td class="text14">&nbsp;<span title="tvexlk4" >Eksport fra land</span></td>
					           							...
					           							<tr>
										           			<td class="text14" colspan="3">&nbsp;<span title="tvmtxt4" >Yderligere opplysninger</span></td>
															<td class="text14">&nbsp;<span title="tvmsk4" >Språk</span></td>
														</tr>
									           			<tr>
										           			<td class="text14" colspan="3" >
													...
													<table width="100%" align="left" border="0">
														<tr align="left" >
															<td class="text14"><button name="specialInformationButtonClose" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('specialInformationCode');">&nbsp;<spring:message code="systema.tvinn.sad.ok"/></button> 
															</td>
														</tr>
													</table>
								        ...
								        <span style="position:absolute; left:280px; top:800px; width:700px; height:200px;" id="previousDocuments" class="popupWithInputText"  >
								           		<div class="text10" align="left">
								           			<table width="100%">
								           				...
								           				<tr>
										           			<td class="text14">&nbsp;<span title="tvtdt" >Dok.type</span></td>
										           			<td class="text14">&nbsp;<span title="tvtdr" >Dok.ref.</span></td>
															<td class="text14">&nbsp;<span title="tvtdsk" >Dok.språk</span></td>
															<td class="text14">&nbsp;<span title="tvtdo" >Opplysninger</span></td>
															<td class="text14">&nbsp;<span title="tvtdos" >Opplysn.språk</span></td>
														</tr>
									           			<tr>
					        ...
					        <td width="50%" valign="top">
						 		<table border="0" cellspacing="1" cellpadding="0">
						 			<tr>
							            <td class="text14" nowrap colspan="2" align="left"><b>&nbsp;31.</b>Kolli merke &nbsp;</td>
							           	<td class="text14" align="left">&nbsp;</td>
							        </tr>
							        
							        <tr>
							            <td class="text14" align="left">&nbsp;&nbsp;&nbsp;Kolli merke &nbsp;</td>
								        ...
								        <span style="position:absolute; left:480px; top:800px; width:450px; height:320px;" id="goodsMark" class="popupWithInputText"  >
								           		<div class="text10" align="left" valign="top">
													...
													<table width="100%" align="left" border="0">
														<tr align="left" >
															<td  class="text14"><button name="goodsMarkButtonClose" class="buttonGrayInsideDivPopup" type="button" onClick="hidePop('goodsMark');">&nbsp;<spring:message code="systema.tvinn.sad.ok"/></button> 
															</td>
														</tr>
													</table>
												</div>
				...
				<td colspan="2">&nbsp;&nbsp;
		            	<table width="99%" align="center" class="tableBorderWithRoundCornersDarkRed" border="0" cellspacing="2" cellpadding="0">
		            		<tr>
							<td width="100%" align="left" valign="top" class="text14" >
								<table width="50%" align="left" border="0" cellspacing="0" cellpadding="0">
							 		<tr height="18px">
							 			<td class="text14">
									        ...
									        <div class="text14" style="position: relative;" align="left">
											<span style="position:absolute;top:2px; width:250px;" id="sikkerhet_info" class="popupWithInputText text14"  >
					           					TODO
											</span>
											</div>	
						 				</td>
					 				...
					 				<tr>
										...
										<div class="text14" style="position: relative;" align="left">
											<span style="position:absolute;top:2px; width:250px;" id="betalmade_info" class="popupWithInputText text14"  >
							           			<ul>
							           				<c:forEach var="code" items="${model.ncts116_BetalningTransport_CodeList}" >
											 		...
											 		<td>
												 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
													        ...
													        <tr>
													            ...
													            <td class="text14" align="left" >&nbsp;&nbsp;<span title="tvskss">Språkkode</span>
													        ...
													        <tr>
													            ...
													            <td >
														        		...
														        		<tr>
														            		...
														            		<td class="text14" align="left" >&nbsp;<span title="tvlkss">Land</span>
										 		...
										 		<tr>
											 		<td>
												 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
													        ...
													        <tr>
											        				<td class="text14" align="left" >&nbsp;&nbsp;<span title="tvtinks">TIN</span></td>
													        </tr>
													        <tr>
													        ...
													        <tr>
													            ...
													            <td class="text14" align="left" >&nbsp;&nbsp;<span title="tvskks">Språkkode</span>
													        ...
													        <tr>
													            ...
													            <td >
														        		...
														        		<tr>
														            		...
														            		<td class="text14" align="left" >&nbsp;<span title="tvlkks">Land</span>
