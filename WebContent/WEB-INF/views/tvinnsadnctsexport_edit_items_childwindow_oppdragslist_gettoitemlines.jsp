				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						...
						<tr>
							...
							<td class="text14">&nbsp;&nbsp;Tar</td>
							<td class="text14">&nbsp;&nbsp;Tolldek.nr.</td>
							<td class="text14">&nbsp;&nbsp;Ekst.ref.nr.</td>
							<td class="text14">&nbsp;&nbsp;Dato</td>
							<td class="text14">&nbsp;&nbsp;Løpenr</td>
							<td class="text14">&nbsp;&nbsp;Status</td>
							<td class="text14">&nbsp;&nbsp;Avsender</td>
							<td class="text14">&nbsp;&nbsp;Mottaker</td>
							<td class="text14">&nbsp;&nbsp;Godsnr</td>
						 </tr>
						 <tr>	
							<td class="text14">&nbsp;<input type="text" class="inputText" name="avd" id="avd" size="5" maxlength="10" value="${searchFilter.avd}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="sg" id="sg" size="3" maxlength="3" value="${searchFilter.sg}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="opd" id="opd" size="8" maxlength="7" value="${searchFilter.opd}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="xref" id="xref" size="10" maxlength="35" value="${searchFilter.xref}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="datum" id="datum" size="7" maxlength="6" value="${searchFilter.datum}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="setll" id="setll" size="10" maxlength="35" value="${searchFilter.setll}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="status" id="status" size="1" maxlength="1" value="${searchFilter.status}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="avsNavn" id="avsNavn" size="9" maxlength="50" value="${searchFilter.avsNavn}"></td>
							<td class="text14">&nbsp;<input type="text" class="inputText" name="motNavn" id="motNavn" size="9" maxlength="50" value="${searchFilter.motNavn}"></td>
					...
					<table id="angivelseList" class="display compact cell-border" width="100%" >
						...
						<tr class="tableHeaderField" >
		                    ...
		                    <th class="text14" title="sg">&nbsp;Sign&nbsp;</th>
		                    <th class="text14" title="opd">&nbsp;Tolldeknr&nbsp;</th>
		                    <th class="text14" title="h_xref">&nbsp;Ekst.ref.nr&nbsp;</th>
		                    <th class="text14" title="datum">&nbsp;Datum&nbsp;</th>
		                    <th class="text14" title="setll">&nbsp;Løpenr&nbsp;</th>
		                ...
		                <c:forEach var="record" items="${model.angivelseList}" varStatus="counter">    
			               ...
			               <td class="text14">&nbsp;${record.sg}</td>
			               <%-- <td nowrap style="cursor:pointer;" class="text14MediumBlue" id="avd${record.avd}@opd${record.opd}@xref${record.xref}@refnr${record.refnr}@mrn${record.dkeh_mrn}@valuta${record.dkeh_221}@blp${record.dkeh_222}" >  --%>
			               <td nowrap style="cursor:pointer;" class="text14MediumBlue" id="avd${record.avd}@opd${record.opd}@xref${record.h_xref}" >
		               	   ...
		               	   <td class="text14">&nbsp;${record.setll}</td>
