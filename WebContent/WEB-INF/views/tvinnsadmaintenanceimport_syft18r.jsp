			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="30%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Kunders likvidit.koder</font>&nbsp;<font class="text14">SYFT18 / CUNDF</font>&nbsp;
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.kundnr}&nbsp;</font></td>
				               ...
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.knavn}&nbsp;</font></td>
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.adr1}&nbsp;</font></td>
		                       <td align="center"   class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.sylikv}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="tvinnsadmaintenanceimport_syft18r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="50%" cellspacing="1" border="0" align="left">
			    	    ...
			    	    <tr>
							<td class="text14" title="KUNDNR">&nbsp;Kundenr</td>
							<td class="text14" title="KNAVN">&nbsp;Navn</td>
							<td class="text14" title="SYLIKV">&nbsp;Likv.kode</td>
						</tr>
						<tr>
						...
						<td >
							<select class="inputTextMediumBlue" name="sylikv" id="sylikv">
