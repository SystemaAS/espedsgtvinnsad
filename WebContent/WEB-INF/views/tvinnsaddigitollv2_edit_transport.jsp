 ...
 <td>	
	...
	<table style="width:100%;"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25">
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 id="alinkItems" style="display:block;" href="tvinnsaddigitollv2_manifest_lines.do?action=doFetch&efpro=${Xmodel.record.efpro}&efsg=${Xmodel.record.efsg}
						...
						<table class="formFrameHeader" style="width:100%;"  border="0" cellspacing="1" cellpadding="0">
					 		<tr height="15">
					 			<c:choose>
						 			...
						 			<c:otherwise>
						 				<td class="text14White">&nbsp;&nbsp;Transportmåte</td>
						 			</c:otherwise>
					 			</c:choose>
			 				</tr>
			            </table>
		            ...
		            <tr >
						...
						<table class="formFrame" style="width:100%;" border="0" cellspacing="1" cellpadding="0">
			 				<c:choose>
				 				...
				 				<c:otherwise>
									...
									<tr>
				 					...
				 					<tr>
					 					<td><input required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" type="text" class="inputTextMediumBlueMandatoryField" name="efavd" id="efavd" size="5" maxlength="4" value="${Xmodel.record.efavd}"></td>
					 					<td><input required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" type="text" class="inputTextMediumBlueMandatoryField" name="efsg" id="efsg" size="4" maxlength="3" value="${Xmodel.record.efsg}"></td>
					 					<td>
					 						<c:choose>
							 				<c:when test="${Xmodel.record.efpro != '0'}">
							 					<input required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" type="text" class="inputTextMediumBlueMandatoryField" name="efpro" id="efpro" size="9" maxlength="8" value="${Xmodel.record.efpro}">
							 				</c:when>	
							 				<c:otherwise>
			 				...
			 				<tr>
								...
								<td class="text14">&nbsp;<span title="efeta">Fører-navn</span><font class="text16RedBold" >*</font></td>
								<td class="text14">&nbsp;<span title="efeta">Fører-epost</span><font class="text16RedBold" >*</font></td>
								...
								<td>
									<c:choose>
					 				<c:when test="${Xmodel.record.ef3039e != '0'}">
					 					<input onKeyPress="return numberKey(event)" style="text-align: right" required oninvalid="this.setCustomValidity('Obligatorisk')" oninput="setCustomValidity('')" type="text" class="inputTextMediumBlueMandatoryField" name="ef3039e" id="ef3039e" size="7" maxlength="6" value="${Xmodel.record.ef3039e}">
					 				</c:when>
					 				<c:otherwise>
