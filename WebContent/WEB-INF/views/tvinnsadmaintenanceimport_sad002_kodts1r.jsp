			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="30%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Ekspeditionstyper</font>&nbsp;<font class="text14">SAD002 / KODTTS1</font>&nbsp;
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.ks1typ}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ks1ftx}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="tvinnsadmaintenanceimport_sad002_kodts1r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="60%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text14" title="KS1TYP">&nbsp;<font class="text14RedBold" >*</font>Kode</td>
						<td class="text14" title="KS1FTX">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
