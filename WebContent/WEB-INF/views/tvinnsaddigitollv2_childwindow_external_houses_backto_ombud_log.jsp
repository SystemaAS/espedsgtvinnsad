...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsaddigitollv2_childwindow_external_houses_backto_ombud_log.js?ver=${user.versionEspedsg}"></SCRIPT>
		...
		<td valign="top">
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="mainList" class="display compact cell-border" width="100%" >
		                ...
		                <tbody>
		                <c:forEach var="record" items="${model.sadmolhffList}" varStatus="counter">    
			               <tr class="text14">
			               	   <%--	
			                   <td style="cursor:pointer;" class="text14MediumBlue" id="orgnr${record.orgnr}_name${record.name}_commtype${record.commtype}_format${record.format}" >
				                ...
				                --%>	
			               	   <td class="text14">&nbsp;${record.ehdkh}</td>
			               	   <td class="text14">&nbsp;${record.ehlnrt}</td>
