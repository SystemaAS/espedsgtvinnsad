...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsaddigitollv2_edit_externalhouse.js?ver=${user.versionEspedsg}"></SCRIPT>
 ...
 <td>	
	...
	<table  style="width:100%;"  class="text11" cellspacing="0" border="0" cellpadding="0">
		...
		<tr height="25">
					...
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 id="alinkTransport" style="display:block;" href="tvinnsaddigitollv2_edit_transport.do?action=doFind&etlnrt=${model.ehlnrt}">													
							<font class="tabDisabledLink">
								&nbsp;Transport&nbsp;
								<font class="text14MediumBlue">&nbsp;${model.ehlnrt}</font>
								
							</font>
						</a>
					</td>
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td title="Master-Doknr:${model.ehlnrm}" width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a tabindex=-1 id="alinkMaster" style="display:block;" href="tvinnsaddigitollv2_edit_master.do?action=doFind&emlnrt=${model.ehlnrt}&emlnrm=${model.ehlnrm}">
							<font class="tabDisabledLink">
								&nbsp;<spring:message code="systema.tvinn.sad.digitoll.list.tab.master"/>
							</font>
							<img src="resources/images/update.gif" border="0" alt="edit">
							<c:if test="${model.ehlnrm > 0}">
								<font class="text14MediumBlue">&nbsp;${model.ehlnrm}</font>
							</c:if>
						</a>
					</td>
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
						...
						<c:if test="${model.record.ehlnrh > 0}">
							<font class="text14MediumBlue">&nbsp;${model.record.ehdkh}</font>
						</c:if>
					</td>
					
					<td width="60%" class="tabFantomSpace" align="right" nowrap><font class="tabDisabledLink">&nbsp;</font>
						<c:if test="${not empty model.record.ehuuid}">
				 			<span cursor:pointer;" onClick="showPop('requestIdBup');" title="Sist godkjente MRN" class="inputTextReadOnly text11" style="vertical-align:super;">MRN:&nbsp;${model.record.ehmid_own}</span>
				 			&nbsp;&nbsp;
							...
							<span style="position:absolute; left:-200px; top:15px; width:280px;" id="requestIdBup" class="popupWithInputText"  >
								<div class="text12" align="left">
				           			<span class="uuidLink" style="color:green;cursor:pointer;" id="${model.record.ehuuid_own}">${model.record.ehuuid_own}</span>
					           		<br/>
		...
		<table align="center" style="width:100%;"  border="0" cellspacing="1" cellpadding="0">
			...
			<tr >
				<td class="text14" align="left" >
		    		...
		    		<span title="MRN nr. hos toll.no - per Master" >MRN-Api&nbsp;<a class="uuidLinkParent text14SkyBlue" id="${model.record.ehmid}">${model.record.ehmid}</a></span>
			...
			<td colspan="3" style="width:100%" class="text14" valign="top">
				<table style="width:90%" align="left" border="0" cellspacing="1" cellpadding="0">					
					...
					<tr>
						...
						<td nowrap class="text14">&nbsp;<span title="ehtdn"><span id="ehtdnIdSpan" style="cursor:pointer;color:brown;">Opd</span><font class="text16RedBold" >*</font>
							<span title="Søk i sadi">/&nbsp;S</span>
						...
						<td class="text14">&nbsp;<span title="ehst2">
								St<a tabindex=-1 id="updateInternalStatus2Link_OBSOLETE" name="updateInternalStatus2Link_OBSOLETE" runat="server" href="#">.</a>2
								</span>
						</td>
						<td class="text14">&nbsp;<span title="ehst3"><a tabindex=-1 id="updateInternalStatus3Link_OBSOLETE" name="updateInternalStatus3Link_OBSOLETE" runat="server" href="#"><span class="text14">St.3</span></a></span></td>
					...
					<tr>	
						...
						<td class="text14">
							<c:choose>
								...
								<c:otherwise>
									<input readonly type="text" class="inputTextReadOnly" name="ehdkm_fh" id="ehdkm_fh" size="25" maxlength="50" value="${model.record.ehdkm_fh}">
								</c:otherwise>
							</c:choose>		
						</td>
					</tr>
