...
<!-- =====================end header ==============================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadimport_edit_items_childwindow_containernr.js?ver=${user.versionEspedsg}"></SCRIPT>
 	...
 	<table width="100%" class="tableBorderWithRoundCorners3D_RoundOnlyOnBottom" border="0" cellspacing="0" cellpadding="0">
		...
		<table border="0" align="left">
				 					  ...
				 					  <c:forEach items="${model.containernrList}" var="record" varStatus="counter">    
							               ...
							               <td width="2%" class="tableCell" align="center">
							               	   <c:if test="${not empty record.svcnr}">
							                   		<a onclick="javascript:return confirm('Er du sikker på at du vil slette denne?')" tabindex=-1 href="tvinnsadimport_edit_items_childwindow_containernr_edit.do?action=doDelete&user=${user.user}&svavd=${record.svavd}&svtdn=${record.svtdn}&svli=${record.svli}&svcnr=${record.svcnr}">
			...
			<%-- ------------------------------------------------- --%>
           	...
           	<tr>
	 			<td >
	 				<form action="tvinnsadimport_edit_items_childwindow_containernr_edit.do" name="updateItemContainernrForm" id="updateItemContainernrForm" method="post">
						 		...
						 		<table  class="tableBorderWithRoundCornersGray" width="90%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
						        		    <td class="text14" align="left" >
							        			...
							        			&nbsp;<input class="inputFormSubmit" type="submit" name="submit" id="submit" value='<spring:message code="systema.tvinn.sad.import.item.line.init.createnew.submit"/>'>
							        		</td>
