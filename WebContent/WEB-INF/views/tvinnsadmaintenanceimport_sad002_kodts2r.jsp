			...
			<tr height="2"><td></td></tr>
				<tr height="25"> 
					...
					<td width="30%" valign="bottom" class="tab" align="center">
						<font class="tabLink">Landkoder</font>&nbsp;<font class="text14">SAD002 / KODTS2</font>&nbsp;
				...
				<table id="containerdatatableTable" width="90%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td width="2%" class="tableCellFirst" style="border-style: solid;border-width: 0px 1px 1px 1px;border-color:#FAEBD7;"><font class="text14">&nbsp;${record.ks2lk}&nbsp;</font></td>
				               
				               <td class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ks2ftx}&nbsp;</font></td>
				               <td align="center" class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ks2nas}&nbsp;</font></td>
				               <td width="2%" align="center" class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ks2mo}&nbsp;</font></td>
				               <td width="2%" align="center" class="tableCell" style="border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" ><font class="text14">&nbsp;${record.ks2pre}&nbsp;</font></td>
	 	    ...
	 	    <tr >
				...
				<form action="tvinnsadmaintenanceimport_sad002_kodts2r_edit.do" name="formRecord" id="formRecord" method="POST" >
					...
					<table width="70%" cellspacing="1" border="0" align="left">
			    	    <tr>
						<td class="text14" title="KS2LK">&nbsp;<font class="text14RedBold" >*</font>Kode</td>
						<td class="text14" title="KS2FTX">&nbsp;<font class="text14RedBold" >*</font>Fritekst</td>
						<td class="text14" title="KS2NAS">&nbsp;Språk</td>
						<td class="text14" title="KS2MO">&nbsp;M/O</td>
						<td class="text14" title="KS2PRE">&nbsp;Pref.</td>
