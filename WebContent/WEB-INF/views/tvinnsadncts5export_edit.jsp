...
<!-- =====================end header ==========================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadncts5export_edit.js?ver=${user.versionEspedsg}"></SCRIPT>
		...
		<tr height="25"> 
			<td width="20%" valign="bottom" class="tabDisabled" align="center" nowrap>
				<a id="alinkTopicList" tabindex=-1 style="display:block;" 
					<c:choose>
						<c:when test="${empty model.record.thsg}">href="tvinnsadncts5export.do?action=doFind&sign=${user.tvinnSadSign}"</c:when>
						<c:otherwise>href="tvinnsadncts5export.do?action=doFind&sign=${model.record.thsg}"</c:otherwise>
					</c:choose> >
			...
			<c:choose> 
			    <c:when test="${editActionOnTopic=='doUpdate' or editActionOnTopic=='doFetch'}">
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkLogging" tabindex=-1 style="display:block;" href="tvinnsadncts5export_logging.do?avd=${model.record.thavd}&sign=${model.record.thsg}
													&opd=${model.record.thtdn}&tullId=${model.record.thtuid}&mrnNr=${model.record.thtrnr}
													&status=${model.record.thst}&datum=${model.record.thdt}">
							<font class="tabDisabledLink">
					...
					<td width="1px" class="tabFantomSpace" align="center" nowrap><font class="tabDisabledLink">&nbsp;</font></td>
					<td width="15%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkArchive" tabindex=-1 style="display:block;" href="tvinnsadncts5export_archive.do?avd=${model.record.thavd}&sign=${model.record.thsg}
													&opd=${model.record.thtdn}&tullId=${model.record.thtuid}&mrnNr=${model.record.thtrnr}
													&status=${model.record.thst}&datum=${model.record.thdt}">
							<font class="tabDisabledLink">
	    ...
	    <c:when test="${editActionOnTopic=='doUpdate' or editActionOnTopic=='doFetch'}">
			...
			<tr >
				...
				<td>
					<table width="100%">
						<tr>
						<td class="text14MediumBlue" align="right">
							<table>
							<tr>
								<td class="text14MediumBlue" valign="bottom">
								...
								<td class="text14MediumBlue">
									<a href="tvinnsadncts5export_edit_printTopic.do?avd=${model.record.thavd}&opd=${model.record.thtdn}">
			...
			<tr >
				<td colspan="2" class="text14MediumBlue" align="left">
					 		...
					 		<td width="100%">
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
							            ...
							            <td class="text14" align="left" >&nbsp;<font class="text16RedBold" >*</font><span title="thnas">Navn&nbsp;</span>
							        ...
							        <tr>
							        		<td>
								        		<table>
								        		<tr>
								            		<td class="text14" align="left" >&nbsp;<font class="text16RedBold" >*</font><span title="thpss">Postadresse</span></td>
								            		<td align="left">&nbsp;</td>
								            	</tr>
								        		<tr>
								            		<td align="left">
						 		...
						 		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							        ...
							        <tr>
							        		<td>
								        		<table>
								        		<tr>
								            		<td class="text14" align="left" >&nbsp;<font class="text16RedBold" >*</font><span title="thpsk">Postadresse</span></td>
								            		<td align="left">&nbsp;</td>
								            	</tr>
								        		<tr>
								            		<td align="left">
							            ...
							            <td >
								        		...
								        		<tr>
								            		...
								            		<td class="text14" align="left" >&nbsp;<font class="text16RedBold" >*</font><span title="thlkk">Land</span>
							        ...
							        <tr >
							        	<td >&nbsp;&nbsp;
							            	<table width="90%" class="tableBorderWithRoundCornersGray" align="left" border="0" cellspacing="2" cellpadding="0">
							            		...
							            		<tr height="5"><td></td></tr>
							            		<tr>
							            			<td colspan="3" class="text14">&nbsp;<span title="thgkd">Annen Garanti</span></td>
							            		</tr>
							            		<tr>
			 				    ...
			 				    <td class="text9BlueGreen" valign="bottom" align="left" >
				 				    ...
				 				    <c:choose>
					 				    <c:when test="${ model.record.thst == 'G' ||  model.status=='F' || model.record.thst == 'M' || empty model.record.thst}">
						 				    	<input tabindex=-1 class="inputFormSubmit" type="submit" name="submit" onclick="javascript: form.action='tvinnsadncts5export_edit.do';" value='<spring:message code="systema.tvinn.sad.ncts.export.createnew.submit"/>'/>
						 				    	&nbsp;&nbsp;
						 				    	<c:if test="${not empty model.record.thtdn}">
						 				    		<input tabindex=-2 class="inputFormSubmit" type="submit" name="send" onclick="javascript: form.action='tvinnsadncts5export_send.do';" value='<spring:message code="systema.tvinn.sad.ncts.export.createnew.send"/>'/>
						 				    	</c:if>
					 				    </c:when>
					 				    <c:otherwise>
				            ...
				            <tr >	
			            		<td class="text">&nbsp;</td> 
			 				    <td class="text9BlueGreen" valign="bottom" align="left" >
				 				    ...
				 				    <c:choose>
					 				    <c:when test="${ model.record.thst == 'G' ||  model.status=='F' || model.record.thst == 'M' || empty model.record.thst}">
						 				    	<input tabindex=-1 class="inputFormSubmit" type="submit" name="submit2" onclick="javascript: form.action='tvinnsadncts5export_edit.do';" value='<spring:message code="systema.tvinn.sad.ncts.export.createnew.submit"/>'/>
						 				    	&nbsp;&nbsp;
						 				    	<c:if test="${not empty model.record.thtdn}">
						 				    		<input tabindex=-2 class="inputFormSubmit" type="submit" name="send2" onclick="javascript: form.action='tvinnsadncts5export_send.do';" value='<spring:message code="systema.tvinn.sad.ncts.export.createnew.send"/>'/>
						 				    	</c:if>
					 				    </c:when>
					 				    <c:otherwise>
				            ...
				            <td width="50%" align="left" valign="top" class="text14" align="left" >   
				            		<table width="99%" align="left" border="0" cellspacing="0" cellpadding="0">
		            					...
		            					<tr>
											...
											<div class="text12" style="position: relative;" align="left">
												<span style="position:absolute;top:2px; width:250px;" id="spesOmstand_info" class="popupWithInputText text12"  >
								           			<ul>
								           				<c:forEach var="code" items="${model.ncts096_SpecOmst_CodeList}" >
					            		...
					            		<tr>
					            			<td class="text14">&nbsp;&nbsp;<span title="thlosd">Lossested</span>
 ...
 <tr>
	<td>
		...
		<div id="dialogUpdateStatus" title="Dialog">
			<form action="tvinnsadncts5export_updateStatus.do" name="updateStatusForm" id="updateStatusForm" method="post">
