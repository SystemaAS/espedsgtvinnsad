...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsaddigitollv2_childwindow_tur_automationSysped.js?ver=${user.versionEspedsg}"></SCRIPT>
				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<td>
						...
						<tr>
							...
							<td class="text14">&nbsp;<input type="text" readonly class="inputTextReadOnly" name="sign" id="sign" size="6" maxlength="3" value="${user.tvinnSadSign}"></td>
