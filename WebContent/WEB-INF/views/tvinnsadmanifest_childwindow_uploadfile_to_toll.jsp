...
<!-- =====================end header ====================================-->
	...
	<SCRIPT type="text/javascript" src="resources/js/tvinnsadmanifest_childwindow_uploadfile_to_toll.js?ver=${user.versionEspedsg}"></SCRIPT>
			...
			<%-- ============================================  --%>
          	...
          	<%-- ============================================  --%>
				...
				<table class="tableBorderWithRoundCorners" >
					<tr>
			 		 <td valign="top" class="text14">&nbsp;Arkiv docs.&nbsp;<span id="tollErrorMessage"></span>
