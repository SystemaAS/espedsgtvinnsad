			...
			<c:choose> 
			    <c:when test="${editActionOnTopic=='doUpdate' or editActionOnTopic=='doFetch'}">
					<td width="12%" valign="bottom" class="tab" align="center" nowrap>
						...
						<font class="text14MediumBlue">[${model.record.setdn}]</font>
					...
					<td width="10%" valign="bottom" class="tabDisabled" align="center" nowrap>
						<a id="alinkNotis" style="display:block;" href="editNotisblock.do?action=doFetch&subsys=sade&orig=topic&avd=${ model.record.seavd}&sign=${ model.record.sesg}
													&opd=${model.record.setdn}&status=${ model.record.sest}&o2_sest=${ model.record.o2_sest}&o2_sedt=${ model.record.o2_sedt}&o2_semf=${ model.record.o2_semf}">
							<font class="tabDisabledLink">
            ...
            <tr>
	            ...
	            <td >
	                <table width="90%" align="left" border="0" cellspacing="0" cellpadding="0">
				 		<tr>
				 			<td class="text14">
				 				<b>&nbsp;22.</b>&nbsp;<font class="text16RedBold" >*</font><span title="sebel1" id="v_sebel1" class="validation">Fakturasum&nbsp;</span>
				 			</td>
				 			<td align="left" >
				 			...
				 			<td class="text14" align="left">
				 				&nbsp;<font class="text16RedBold" >*</font><span title="seval1" id="v_seval1" class="validation">Valuta</span>
			 		...
			 		<td>
			 			<table border="0" cellspacing="1" cellpadding="0">
					        ...
					        <tr height="10"><td></td> </tr>
					            ...
					            <font class="text16RedBold" >*</font><span title="sevkb">Bruttovekt</span>
					            <div class="text11" style="position: relative;" align="left">
							...
							<tr>
					            ...
					            <td >
				            		<select class="selectMediumBlueE2" name="sesam" id="sesam" >
				 				  		<option value="">-velg-</option>
					...
					<tr>
						...
						<td class="text14MediumBlue">
							<select class="selectMediumBlueE2" name="m0035" id="m0035">
			            		<option value="2" <c:if test="${model.record.sendParametersRecord.m0035 == '1'}"> selected </c:if> >Test</option>
