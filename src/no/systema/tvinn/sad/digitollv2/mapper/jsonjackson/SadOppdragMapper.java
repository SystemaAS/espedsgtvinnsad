 ...
 * 
 */
public class SadOppdragMapper {
	private static final Logger logger = LoggerFactory.getLogger(SadOppdragMapper.class.getName());
	 ...
	 * @throws Exception
	 */
	public SadOppdragContainer getContainer(String utfPayload) throws Exception{
		ObjectMapper mapper = new ObjectMapper();  
		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES,false);
		SadOppdragContainer container = null;
		if(utfPayload!=null){
			//At this point we now have an UTF-8 payload
			container = mapper.readValue(utfPayload.getBytes(), SadOppdragContainer.class); 
