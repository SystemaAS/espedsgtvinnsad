 ...
 * @date Aug, 2023
 */
public class GeneralUpdateContainer {
	...
	private Collection<GeneralUpdateRecord> list = null;
	public void setList(Collection<GeneralUpdateRecord> value){ this.list = value;}
