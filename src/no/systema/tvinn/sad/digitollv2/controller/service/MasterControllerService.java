...
public class MasterControllerService {
	 ...
	 * @return
	 */
	public int updateRecord(String applicationUser, SadmomfRecord recordToValidate, String mode, StringBuffer errMsg) {
		int retval = 0;
		
		
		//get BASE URL
		final String BASE_URL = SadDigitollUrlDataStore.SAD_UPDATE_DIGITOLL_MASTERCONSIGNMENT_EXTERNAL_MASTER_URL;
		//add URL-parameters
