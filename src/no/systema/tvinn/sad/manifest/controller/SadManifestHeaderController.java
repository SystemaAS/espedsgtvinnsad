...
public class SadManifestHeaderController {
	...
	public ModelAndView doManifestEdit(ModelMap model, @ModelAttribute ("record") GodsjfDao recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
