 ...
 *
 */
public class SadNcts5ExportHeaderValidator implements Validator {
	private static final Logger logger = LoggerFactory.getLogger(SadNcts5ExportHeaderValidator.class.getName());
