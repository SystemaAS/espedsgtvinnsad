...
public class SadNcts5ExportAjaxHandlerController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "getSpecificTopicItemChosenFromGuiElement_TvinnSadNcts5Export.do", method = RequestMethod.GET)
	public @ResponseBody Set<JsonSadNctsExportSpecificTopicItemRecord> getSpecificTopicItemChosenFromHtmlList
		 ...
		 logger.info("Inside: getSpecificTopicItemChosenFromGuiElement_TvinnSadNcts5Export.do()");
	   ...
	   * @return
	   */
	  @RequestMapping(value = "initCreateNewTopic_TvinnSadNcts5Export.do", method = RequestMethod.GET)
	   ...
	   * @return
	   */
	  @RequestMapping(value = "validateGuaranteeNrAndCode_TvinnSadNcts5Export.do", method = RequestMethod.GET)
	  public @ResponseBody Set<JsonTvinnSadCustomerRecord> validateGuaranteeNrAndCode(@RequestParam String applicationUser, @RequestParam String guaranteeNumber, @RequestParam String guaranteeCode ) {
			...
			//get BASE URL = RPG-PROGRAM
			//---------------------------
			String BASE_URL = SadNctsExportUrlDataStore.NCTS5_EXPORT_BASE_VALIDATE_SPECIFIC_TOPIC_GUARRANTEE_URL;
			//url params
	  ...
	  @RequestMapping(value = "searchTaricVarukod_TvinnSadNcts5Export.do", method = RequestMethod.GET)
	   ...
	   * @return
	   */
	  @RequestMapping(value = "importSadExportAsNctsExportItemLine_SadNcts5Export.do", method = RequestMethod.GET)
