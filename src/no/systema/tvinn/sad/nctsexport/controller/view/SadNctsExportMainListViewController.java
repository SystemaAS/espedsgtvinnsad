package no.systema.tvinn.sad.nctsexport.controller.view;
...
@Controller
public class SadNctsExportMainListViewController {
	private static final Logger logger = LoggerFactory.getLogger(SadNctsExportMainListViewController.class.getName());
	 ...
	 * 
	 */
	@RequestMapping(value="tvinnsadNctsExportMainListExcelView.do", method={RequestMethod.GET})
	public ModelAndView getItemListExcelView(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		...
		final String EXCEL_VIEW = "tvinnsadNctsExportMainListExcelView";
		
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		List<JsonSadNctsExportTopicListRecord> mainList = null;
