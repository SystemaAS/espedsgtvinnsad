...
@Controller
@Scope("session")
public class SadNcts5ExportHeaderController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = LoggerFactory.getLogger(SadNcts5ExportHeaderController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_edit.do",  params="action=doPrepareCreate", method={RequestMethod.GET, RequestMethod.POST })
	public ModelAndView doPrepareCreate(HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tvinnsadncts5export_edit");
		logger.info("Method: doPrepareCreate [RequestMapping-->tvinnsadncts5export_edit.do]");
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_edit.do")
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_send.do")
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_edit_printTopic.do",  method={RequestMethod.GET, RequestMethod.POST })
	public ModelAndView doNctsExportEditPrintTopic(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		ModelAndView successView = new ModelAndView("redirect:tvinnsadncts5export.do?action=doFind&sign=" + appUser.getTvinnSadSign());
		
		String method = "doNctsExportEditPrintTopic [RequestMapping-->tvinnsadncts5export_edit_printTopic.do]";
		logger.info("Method: [RequestMapping-->tvinnsadncts5export_edit_printTopic.do]");
		String opd = request.getParameter("opd");
		String avd = request.getParameter("avd");
	...
	@RequestMapping(value="tvinnsadncts5export_copyTopic.do", method={RequestMethod.POST} )
	public ModelAndView doCopyTopic( HttpSession session, HttpServletRequest request){
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		
		ModelAndView successView = new ModelAndView("tvinnsadncts5export_edit");
		ModelAndView fallbackOnErrorView = new ModelAndView("redirect:tvinnsadncts5export.do?action=doFind&sign=" + appUser.getTvinnSadSign());
		
		JsonSadNctsExportTopicCopiedContainer jsonNctsExportTopicCopiedContainer = null;
		String method = "doCopyTopic [RequestMapping-->tvinnsadncts5export_copyTopic.do]";
		logger.info("Method: " + method);
		Map model = new HashMap();
	 ...
	 * 
	 */
	@RequestMapping(value="tvinnsadncts5export_updateStatus.do")
