...
@Controller
@Scope("session")
public class SadNcts5ExportHeaderLoggingController {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = LoggerFactory.getLogger(SadNcts5ExportHeaderLoggingController.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_logging.do",  method= RequestMethod.GET)
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("tvinnsadncts5export_logging");
		logger.info("Method: doShowList [RequestMapping-->tvinnsadncts5export_logging.do]");
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_renderEdifact.do", method={ RequestMethod.GET })
	public ModelAndView doSadNctsExportRenderEdifact(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		logger.info("Inside doSadNcts5ExportRenderEdifact...");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
	...
	@RequestMapping(value="tvinnsadncts5export_renderXml.do", method={ RequestMethod.GET })
	public ModelAndView doSadNctsExportRenderXml(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		logger.info("Inside doSadNcts5ExportRenderXml...");
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
	 ...
	 * @return
	 */
	@RequestMapping(value="tvinnsadncts5export_renderLargeText.do",  method= RequestMethod.GET)
	public ModelAndView doSadNctsExportRenderLargeText(HttpSession session, HttpServletRequest request, HttpServletResponse response){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		logger.info("Inside doSadNcts5ExportRenderLargeText...");
