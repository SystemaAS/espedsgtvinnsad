 ...
 * 
 */
package no.systema.tvinn.sad.sadimport.service.html.dropdown;
 ...
 * 
 */
public class SadImportDropDownListPopulationService {
	private static final Logger logger = LoggerFactory.getLogger(SadImportDropDownListPopulationService.class.getName());
